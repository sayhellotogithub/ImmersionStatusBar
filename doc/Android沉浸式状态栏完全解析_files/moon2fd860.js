...
var l,u,d,m,w,f,p,_=/MicroMessenger/i.test(navigator.userAgent),h=window.define,g=0,v=2,y=4,O=9,j=10;
if(window.__initCatch=function(e){
l=e.idkey,u=e.startKey||0,d=e.limit,m=e.badjsId,w=e.reportOpt||"",f=e.extInfo||"";
},window.__moon_report=function(o){
if(/mp\.weixin\.qq\.com/.test(location.href)&&!(Math.random()>.5)&&_&&(top==window||/mp\.weixin\.qq\.com/.test(top.location.href))&&(t(o)&&(o=[o]),
e(o)&&""!=l)){
var r="",a=[],s=[],c=[],w=[];
...
var i=e.localStorage,a=document.head||document.getElementsByTagName("head")[0],s=1,c=2,l=.001,u={
prefix:"__MOON__",
loaded:[],
unload:[],
